...
require(
    ...
    function($, _, Backbone, isotope, Router, Exhibit, Story, Fade, PageTitle, Title, Input, Login, MessageHandler, Notifications, ErrorLog, Actions, CategoryList, Menu, InfiniteScroll, Nav){
        ...
        $(document).ready(function(){
            ...
            this.messageHandler = new MessageHandler({ el: '#echoed-iframe', EvAg: EventAggregator });
