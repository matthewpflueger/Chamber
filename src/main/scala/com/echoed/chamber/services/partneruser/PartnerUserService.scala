...
class PartnerUserService(
    ...
    def online = {
        ...
        case msg @ UpdatePartnerCustomization(_, useGallery, showGallery, useRemote, remoteVertical, remoteHorizontal, remoteOrientation, widgetTitle, widgetShareMessage) =>
