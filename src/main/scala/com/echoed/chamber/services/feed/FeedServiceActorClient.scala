...
class FeedServiceActorClient extends FeedService with ActorClient with Serializable {
    ...
    def getCategoryStoryFeed(categoryId: String, page: Int) = (feedServiceActor ? GetCategoryStoryFeed(categoryId, page)).mapTo[GetCategoryStoryFeedResponse]
    ...
    def getUserPublicStoryFeed(echoedUserId: String, page: Int) = (feedServiceActor ? GetUserPublicStoryFeed(echoedUserId, page)).mapTo[GetUserPublicStoryFeedResponse]
