...
case class CreateAdminUserServiceResponse(
                ...
                extends AUM with MR[AdminUserService, CreateAdminUserService, AUE]
...
case class LocateAdminUserServiceResponse(
                ...
                value: Either[AUE, AdminUserService])
                extends AUM with MR[AdminUserService, LocateAdminUserService, AUE]
...
case class LoginResponse(
                message: Login, 
                value: Either[AUE, AdminUserService])
                extends AUM with MR[AdminUserService,Login,AUE]
