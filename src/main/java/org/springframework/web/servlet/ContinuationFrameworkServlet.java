...
public abstract class ContinuationFrameworkServlet extends HttpServletBean {
	 ...
	 */
	public static final String SERVLET_CONTEXT_PREFIX = ContinuationFrameworkServlet.class.getName() + ".CONTEXT.";
	 ...
	 */
	public ContinuationFrameworkServlet() {
	}
	 ...
	 */
	public ContinuationFrameworkServlet(WebApplicationContext webApplicationContext) {
	...
	protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
		    ...
		    if (t instanceof ContinuationThrowable) {
		        isContinuation = true;
		        throw (ContinuationThrowable) t;
            } else {
			    failureCause = t;
            }
		}
	...
	private class ContextRefreshListener implements ApplicationListener<ContextRefreshedEvent> {
		...
		public void onApplicationEvent(ContextRefreshedEvent event) {
			ContinuationFrameworkServlet.this.onApplicationEvent(event);
		}
	}
